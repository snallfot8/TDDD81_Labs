...
LOCK TABLES payment WRITE, flight WRITE, weekday_factor WRITE, route WRITE, weekly_schedule WRITE, profit_factor WRITE, contact_person WRITE, person WRITE, creditcard_holder WRITE;
